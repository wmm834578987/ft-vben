...
<template>
  ...
  <div ref="wrap" :style="getWrapStyle" :class="[
    prefixCls,
    getMenuTheme,
    {
      open: openMenu,
    ...
    <ScrollContainer>
      <ul :class="`${prefixCls}-module`">
        <li v-for="item in menuModules" v-bind="getItemEvents(item)" :key="item.path" :class="[
          ...
          <Icon v-else :class="`${prefixCls}-module__icon`" :size="getCollapsed ? 16 : 20"
